...
<c:url var="newURL" value="/quan-tri/don-vi/danh-sach"/>
<c:url var="editNewURL" value="/quan-tri/don-vi/chinh-sua"/>
<c:url var="newAPI" value="/api/unit"/>
<html>
<head>
                ...
                <div class="col-xs-12">
                    ...
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                        <div class="form-group">
                            <label for="displayName" class="col-sm-3 control-label no-padding-right">Tên đơn vị</label>
                            <div class="col-sm-9">
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button class="btn" style="background-color: #6fb3e0!important;border-color: #6fb3e0!important ;margin-left:20px ">
                                    <a style="color: #FFFFFF "href="<c:url value='/quan-tri/don-vi/danh-sach?page=1&limit=20'/>">
                                        Danh sách
                                    </a>
                                </button>
                            </div>
