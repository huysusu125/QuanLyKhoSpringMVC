...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
    ...
    <ul class="nav nav-list">
        <li >
            ...
            <ul class="submenu">
                <li>
                    <a href="<c:url value='/quan-tri/don-vi/danh-sach?page=1&limit=20'/>">
                ...
                <li>
                    <a href="<c:url value='/quan-tri/nhap-hang/danh-sach?page=1&limit=20'/>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Nhập hàng
                    </a>
                    <b class="arrow"></b>
                ...
                <li>
                    <a href="<c:url value='/quan-tri/xuat-hang/danh-sach?page=1&limit=20'/>">
                        <i class="menu-icon fa fa-caret-right"></i>
                        Xuất hàng
                    </a>
                    <b class="arrow"></b>
