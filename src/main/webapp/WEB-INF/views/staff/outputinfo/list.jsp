...
<div class="main-content">
    <form action="<c:url value='/xuat-hang/danh-sach'/>" id="formSubmit" method="get">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url var="createURL" value="/xuat-hang/chinh-sua"/>
                                        <a flag="info"
                                    ...
                                    <table class="table table-bordered" style="text-align:center; font-size:16px">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:url var="updateURL" value="/xuat-hang/chinh-sua">
