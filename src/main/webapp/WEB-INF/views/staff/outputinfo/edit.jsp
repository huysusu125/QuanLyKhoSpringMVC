...
<c:url var="newURL" value="/xuat-hang/danh-sach"/>
<c:url var="editNewURL" value="/xuat-hang/chinh-sua"/>
                    ...
                    <form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button class="btn"
                                        style="background-color: #6fb3e0!important;border-color: #6fb3e0!important ;margin-left:20px ">
                                    <a style="color: #FFFFFF "
                                       href="<c:url value='/xuat-hang/danh-sach?page=1&limit=20'/>">
                                        Danh sách
                                    </a>
                                </button>
                            </div>
